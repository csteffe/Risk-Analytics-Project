...
Below is displayed the candlestick plot including the 4 stocks prices. As Amazon in comparison, has a much higher stock price you can use the zoom to see the 3 other stocks prices evolution over time.  
```{r, echo=F, warning=F, message=F}
...
# Candelstick with the 4 stock prices separetely
...
# log returns plot for the 4 stock prices
