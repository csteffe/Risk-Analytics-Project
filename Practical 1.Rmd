...
The Peaks-over-Threshold method identifies extreme values that are above a designated threshold u. In order to determine the threshold we can apply the MRL-plot and then look at the distribution of data points above this threshold.
