...
We also observe a pattern of the maxima shown by the green smoothed curve which indicates that water levels fluctuate according to a specific logic within a year (i.e. trend and seasonality?). 
